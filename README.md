...
- 存储基线：MySQL + Redis + Flyway + MyBatis Mapper XML
- 文档基线：`docs_new/*.md`
- 项目 skill：`skills/dzcom-project`

## 统一协作入口

从 2026-06-28 起，`dzcom` 与 `dzcom_web` 保持两个独立 Git 仓库，但共享产品契约、开发铁律、handoff、API 契约、gap list 和验收流程统一归档到 `dzcom/docs_new`。

默认入口：

- [当前 handoff](docs_new/00-current-handoff.md)
- [产品契约](docs_new/01-product-contract.md)
- [前端开发铁律](docs_new/02-frontend-laws.md)
- [后端开发铁律](docs_new/03-backend-laws.md)
- [API 契约规则](docs_new/04-api-contract-rules.md)
- [跨仓变更清单](docs_new/05-cross-repo-change-checklist.md)
- [后端补齐清单](docs_new/06-backend-gap-list.md)
- [上下文瘦身规则](docs_new/99-context-slimming-rules.md)

如 `dzcom_web/mock`、前端根目录文档或旧历史文档与上述共享文档冲突，以上述共享文档为准。
...
- 账户域已具备角色定义、角色权限配置、用户角色分配和会话权限失效能力。
