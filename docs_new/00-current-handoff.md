...
- 共享文档归档在 `dzcom/docs_new`。如前端 `dzcom_web/mock`、根目录文档与 `dzcom/docs_new` 内容冲突，以 `dzcom/docs_new` 为准。
- 前端历史 mock/handoff 只作为归档来源，不作为默认事实入口。
...
- 历史前端文档：`mock`、`DEVELOPMENT_RULES.md`、`docs`
