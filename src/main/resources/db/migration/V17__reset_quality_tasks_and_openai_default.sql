...
VALUES
('17000000-0000-0000-0000-000000000201', 'l1-regulatory-disclosure-collection', 'REGULATORY_DISCLOSURE_COLLECTION',
...
('17000000-0000-0000-0000-000000000202', 'l1-exchange-announcement-collection', 'EXCHANGE_ANNOUNCEMENT_COLLECTION',
...
('17000000-0000-0000-0000-000000000203', 'l2-wealth-product-nav-refresh', 'WEALTH_PRODUCT_NAV_REFRESH',
 ...
 'L2银行理财产品和净值专用采集任务。默认不写兜底数据，产品池 upsert 前先入披露记录和质量快照。', CURRENT_TIMESTAMP(3), CURRENT_TIMESTAMP(3)),
